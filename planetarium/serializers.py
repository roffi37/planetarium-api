...
class ShowSessionListSerializer(serializers.ModelSerializer):
    ...
    planetarium_dome_total_seats = serializers.IntegerField(source="planetarium_dome.total_seats", read_only=True)
    tickets_available = serializers.IntegerField(read_only=True)

    class Meta:
        model = ShowSession
        fields = ("id", "show_time", "astronomy_show_title", "astronomy_show_image", "planetarium_dome_name", "planetarium_dome_total_seats", "tickets_available", )
